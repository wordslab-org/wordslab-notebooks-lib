...
# %% auto 0
__all__ = ['insideEventLoop', 'get_notebook_data', 'get_mime_text', 'cell2out', 'cell2xml', 'nb2xml', 'get_notebook_context']
...
try:
    if insideEventLoop:
        loop.run_until_complete(get_notebook_data)
    else:
        asyncio.run(get_notebook_data)
except:
    ...
