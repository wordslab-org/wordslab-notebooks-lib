"""Access wordslab-notebooks execution environment version, platform, urls, ports, directories (install / apps / data / models), and pre-installed models."""

# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/01_environment.ipynb.

# %% auto 0
__all__ = ['WordslabNotebooks']

# %% ../nbs/01_environment.ipynb 2
import os

# %% ../nbs/01_environment.ipynb 4
